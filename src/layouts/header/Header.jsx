                ...
                <ul className="header__menu">
                    {navMenu.map((item, index) => {
                        return <li className="menu__item" key={index}>
                            ...
                            {/* menu children */}
                            {item.children && <div className="menu__children">
                                <ul>
                                    {item.children.map((item, index) => {
                                        return <li key={index}>
                                            <a href={item.href} className="menu__children__title">{item.title}</a>
                                            {item.subMenu && <span>
                                                <FontAwesomeIcon
                                                    icon={faCaretRight}
                                            ...
                                            {/* sub menu */}
                                            {item.subMenu && <div className="menu__sub">
                                                <ul>
                                                    {item.subMenu.map((item, index) => {
                                                        return <li key={index}>
                                                            <a href={item.href} className="menu__sub__title">{item.title} </a>
                                                            {item.children && <span>
                                                                <FontAwesomeIcon
                                                                    icon={faCaretRight}
